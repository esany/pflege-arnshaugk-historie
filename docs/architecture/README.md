...
- `assurance/sociotechnical-research-architecture-deep-research-20260920.md` – #64 Deep-Research-/Review-Evidence zu Entwicklungsringen, externer SOTA, transdisziplinären Schnittstellen, Git/Workspace-Optionen, Solution Archetypes und falsifizierenden Experimenten; keine Requirement-/Method-/Architecture-Decision-Authority
